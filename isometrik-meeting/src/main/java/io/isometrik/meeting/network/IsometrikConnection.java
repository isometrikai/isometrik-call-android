...
public class IsometrikConnection {
  ...
  public void createConnection(@NotNull Isometrik isometrikInstance) {
    ...
    String username = "2" + secretPhraseA + secretPhraseB;
    String password = licenseKey + secretPhraseC;
    this.messagingTopic = "/" + secretPhraseA + "/" + secretPhraseB + "/Message/" + clientIdForTopicSubscribe;
    this.presenceEventsTopic = "/" + secretPhraseA + "/" + secretPhraseB + "/Status/" + clientIdForTopicSubscribe;
