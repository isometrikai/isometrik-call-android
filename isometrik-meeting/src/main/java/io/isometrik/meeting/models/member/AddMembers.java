...
public class AddMembers {
     ...
     * @param gson              the gson
     */
    public void validateParams(@NotNull AddMembersQuery addMembersQuery, @NotNull final CompletionHandler<AddMembersResult> completionHandler, @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration, @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
        String meetingId = addMembersQuery.getMeetingId();
        ...
        if (userToken == null || userToken.isEmpty()) {
            ...
            Call<AddMembersResult> call = retrofitManager.getMemberService().addMembers(headers, bodyParams);

            call.enqueue(new Callback<AddMembersResult>() {
                @Override
                public void onResponse(@NotNull Call<AddMembersResult> call, @NotNull Response<AddMembersResult> response) {
