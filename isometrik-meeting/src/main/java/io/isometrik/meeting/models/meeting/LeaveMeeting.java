...
/**
 * The helper class to validate request params and make the leave meeting request and expose the parsed successful or error response.
 */
public class LeaveMeeting {
    /**
     * Validate params.
     *
     * @param leaveMeetingQuery the leave meeting query
     ...
     * @param gson              the gson
     */
    public void validateParams(@NotNull LeaveMeetingQuery leaveMeetingQuery, @NotNull final CompletionHandler<LeaveMeetingResult> completionHandler, @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration, @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

        String userToken = leaveMeetingQuery.getUserToken();
        String meetingId = leaveMeetingQuery.getMeetingId();
        ...
        if (userToken == null || userToken.isEmpty()) {
            ...
            Call<LeaveMeetingResult> call = retrofitManager.getMeetingService().leaveMeeting(headers, queryParams);

            call.enqueue(new Callback<LeaveMeetingResult>() {
                @Override
                public void onResponse(@NotNull Call<LeaveMeetingResult> call, @NotNull Response<LeaveMeetingResult> response) {
                ...
                @Override
                public void onFailure(@NotNull Call<LeaveMeetingResult> call, @NotNull Throwable t) {
