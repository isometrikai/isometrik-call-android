...
public class StartRecording {
     ...
     * Validate params.
     *
     * @param startRecordingRequestQuery the reject join meeting request query
     ...
     * @param gson                       the gson
     */
    public void validateParams(@NotNull StartRecordingQuery startRecordingRequestQuery, @NotNull final CompletionHandler<StartRecordingResult> completionHandler, @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration, @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

        String userToken = startRecordingRequestQuery.getUserToken();
        String meetingId = startRecordingRequestQuery.getMeetingId();
        ...
        if (userToken == null || userToken.isEmpty()) {
            ...
            Call<StartRecordingResult> call = retrofitManager.getRecordingService().startRecording(headers, bodyParams);

            call.enqueue(new Callback<StartRecordingResult>() {
                @Override
                public void onResponse(@NotNull Call<StartRecordingResult> call, @NotNull Response<StartRecordingResult> response) {
                ...
                @Override
                public void onFailure(@NotNull Call<StartRecordingResult> call, @NotNull Throwable t) {
