 ...
 */
public class RejectJoinMeetingRequest {
    /**
     * Validate params.
     *
     * @param rejectJoinMeetingRequestQuery the reject join meeting request query
     ...
     * @param gson                          the gson
     */
    public void validateParams(@NotNull RejectJoinMeetingRequestQuery rejectJoinMeetingRequestQuery, @NotNull final CompletionHandler<RejectJoinMeetingRequestResult> completionHandler, @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration, @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

        String userToken = rejectJoinMeetingRequestQuery.getUserToken();
        String meetingId = rejectJoinMeetingRequestQuery.getMeetingId();
        ...
        if (userToken == null || userToken.isEmpty()) {
            ...
            Call<RejectJoinMeetingRequestResult> call = retrofitManager.getActionService().rejectJoinMeetingRequest(headers, bodyParams);

            call.enqueue(new Callback<RejectJoinMeetingRequestResult>() {
                @Override
                public void onResponse(@NotNull Call<RejectJoinMeetingRequestResult> call, @NotNull Response<RejectJoinMeetingRequestResult> response) {
                ...
                @Override
                public void onFailure(@NotNull Call<RejectJoinMeetingRequestResult> call, @NotNull Throwable t) {
