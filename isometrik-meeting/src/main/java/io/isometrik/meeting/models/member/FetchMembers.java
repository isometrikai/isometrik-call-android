...
/**
 * The helper class to validate request params and make the fetch meeting members request and expose the parsed successful or error response.
 */
public class FetchMembers {
    /**
     * Validate params.
     *
     * @param fetchMembersQuery the fetch meeting members query
    ...
    public void validateParams(@NotNull FetchMembersQuery fetchMembersQuery,
        ...
        String meetingId = fetchMembersQuery.getMeetingId();
        ...
        if (userToken == null || userToken.isEmpty()) {
            ...
            call.enqueue(new Callback<FetchMembersResult>() {
                ...
                @Override
                public void onFailure(@NotNull Call<FetchMembersResult> call,
                                      @NotNull Throwable t) {
