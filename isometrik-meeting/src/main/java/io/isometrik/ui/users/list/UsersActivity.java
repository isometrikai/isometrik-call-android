...
import io.isometrik.meeting.databinding.IsmActivityUsersBinding;
...
public class UsersActivity extends AppCompatActivity implements UsersContract.View {
    ...
    public void requestUserCredentials(UsersModel user) {
        ...
        @SuppressLint("InflateParams") final View vSelectUser = getLayoutInflater().inflate(R.layout.ism_select_user_popup, null);
